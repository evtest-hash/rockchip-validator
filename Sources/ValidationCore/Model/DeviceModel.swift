...
public enum DeviceModel: String, CaseIterable, Identifiable, Codable {
    case az05  = "AZ05"
    case az07  = "AZ07"
    case az08  = "AZ08"
    case az04a = "AZ04A"
    ...
    public var acceptedVariants: Set<String> {
        switch self {
        case .az05:  return ["RK3288"]
        case .az07:  return ["RK3566"]
    ...
    public static func named(byChipVariant variant: String) -> DeviceModel? {
    ...
    public func contradicts(chipVariant: String?) -> Bool {
    ...
    public var busBitsPerChannel: Int? {
        switch self {
    ...
    public var displayName: String { "\(rawValue) · \(soc)" }
}
